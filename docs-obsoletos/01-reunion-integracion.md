...
Fuente: `fuentes-primarias/Transcripcion_Reunion-OBSOLETO-fuente-primaria-20260917.md` (transcripción completa, archivada — su contenido vivo está sintetizado acá y en `docs/00`).
